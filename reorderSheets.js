...
//translate the name of the month to the Number
  function monthNameToNum(monthname,index) {
    ...
    for (var i = 0; i < months.length; i++) {
        ...
        else
        {
          ...
          //Logger.log("calling checkDate function");
            checkDate(index);
 ...
 //function returns the correct Index of based off the date. 
  function findIndex(date) 
{
    var date2 =  new Date(date);
   //need for loop to test which of the 6 dates that the date correpsonds with
    for (var i = 1; i < 7; i++)
    {
      if(i == 1)
       {
  ...
  //function that finds difference of days between two dates and returns whether or not it's within the 6 weeks
 ...
 function subtractDays(i,date)
{
 ...
 //first function to call - gets the name of each tab and parses the name into the specific dates
    ...
    for (var i = 1 ; i < 7; i++ ) 
    {
     ...
     //  var ui = SpreadsheetApp.getUi();
       ...
       if(subtractDays(i,d) ==  false)
      {
        ...
        } // end of if is sixth sheet
        
        
        
      } // end of if subtract days statement
      
      
    }//end of for loop
    
  } // end of checkDateSheet function
   
    
   
//main function - run three times for right now ?
function myFunction() 
{
// var ui = SpreadsheetApp.getUi();
 for (var i = 0 ; i < 2; i++ ) 
